...
const translations = {
  he: {
    ...
    "booking.termsAccept": "אני מאשר/ת את תנאי ההזמנה.",
    "booking.termsCopy": "המלון שומר לעצמו את הזכות לבטל, לשנות או לדחות כל בקשה או הזמנה בכל זמן ולפי שיקול דעתו הבלעדי. הבקשה אינה מבטיחה זמינות, מחיר או חדר עד לקבלת אישור כתוב מהמלון.",
  ...
  es: {
    ...
    "booking.termsAccept": "Acepto los terminos y condiciones de reserva.",
    "booking.termsCopy": "El hotel se reserva el derecho de cancelar, modificar o rechazar cualquier solicitud o reserva en cualquier momento y a su sola discrecion. La solicitud no garantiza disponibilidad, precio ni habitacion hasta recibir confirmacion escrita del hotel.",
  ...
  en: {
    ...
    "booking.termsAccept": "I accept the booking terms and conditions.",
    "booking.termsCopy": "The hotel reserves the right to cancel, modify or reject any request or booking at any time at its sole discretion. The request does not guarantee availability, price or room until written confirmation is received from the hotel.",
